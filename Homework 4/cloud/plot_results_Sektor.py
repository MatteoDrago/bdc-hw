...
# Load Files
coreset_times = np.load('out/Sektor/coreset_times.npy')
result_times = np.load('out/Sektor/result_times.npy')
objs = np.load('out/Sektor/objs.npy')
k = np.load('out/Sektor/k.npy')
numBlocks = np.load('out/Sektor/numBlocks.npy')
